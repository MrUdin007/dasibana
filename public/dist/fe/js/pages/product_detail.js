...
(() => {
/*!*******************************************!*\
  !*** ./resources/fe/js/product_detail.js ***!
  \*******************************************/
// -----------------------------------------------------------------------------
...
__webpack_require__(/*! jquery-migrate/dist/jquery-migrate */ "./node_modules/jquery-migrate/dist/jquery-migrate.js");
...
$(document).ready(function () {
  ...
  $('.report-btns').on('click', function (e) {
    ...
    $(this).addClass('close-option-rpt'); // $('.list-threads').siblings().find('.mn-tgllsa').addClass('d-none');
