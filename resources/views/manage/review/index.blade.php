                    ...
                    columns: [
                        ...
                        { data: "status" },
                        {
                            ...
                            render: function (data, type, row) {
                                return '<button class="btn cur-p btn-info"><a href="#" title="view" class="btn-pln --view review-detail" data-id="'+row.id+'" data-toggle="modal">View</a></button>'+
