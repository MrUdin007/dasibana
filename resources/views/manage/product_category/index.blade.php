            ...
            <div class="grid_layouts --two-auto">
                ...
                <div class="mn-rght">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{ route('be.product_category') }}">
                                Product Categories
                            </a>
                        </li>
                    </ol>
                    ...
                    <div class="grid_layouts --two-auto">
						...
						<div class="mn-rght">
							<button class="addbsnt --pluses">
								<a href="{{ route('be.product_category.create') }}">
									<i class="ti-plus"></i>
								</a>
							</button>
						</div>
	...
	<script type="text/javascript">
        ...
        (function($) {
            ...
            $(document).ready(function() {
                dataTable = $('#DataTable').DataTable({
                    ...
                    ajax: {
                        url: "{{ $api_url.'product/category/table' }}",
                        type: "post",
                        dataType: "json",
                		data: {
		                    _token: "{{ csrf_token() }}",
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                return '<a class="btn cur-p btn-primary editForm" title="Ubah" href="{{ route("be.product_category.edit",["id"=>"/"]) }}/' + row.id +'" aria-pressed="false" autocomplete="off">Edit</a>'+
        ...
        function deleteRow(id) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url : '{{ $api_url."product/category/delete" }}',
                        method : 'post',
                        data : {
                            token: "{{ csrf_token() }}",
                            id,
