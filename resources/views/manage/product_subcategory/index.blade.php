            ...
            <div class="grid_layouts --two-auto">
                ...
                <div class="mn-rght">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{ route('be.product_subcategory') }}">
                                Product Subcategories
                            </a>
                        </li>
                    </ol>
		...
		<div class="row gap-20 pos-r">
			<div class="masonry-item col-md-12">
				<div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="grid_layouts --two-auto">
						<div class="head-lst">
							<h3 class="page-title">Product Subcategories</h3>
						</div>
						<div class="mn-rght">
							<button class="addbsnt --pluses">
								<a href="{{ route('be.product_subcategory.create') }}">
									<i class="ti-plus"></i>
								</a>
							</button>
						</div>
	...
	<script type="text/javascript">
            ...
            $(document).ready(function() {
                dataTable = $('#DataTable').DataTable({
                    ...
                    language: {
                        ...
                        searchPlaceholder: 'Search Product Subcategories'
                    },
                    ajax: {
                        url: "{{ $api_url.'product/subcategory/table' }}",
                        type: "post",
                        dataType: "json",
                		data: {
		                    _token: "{{ csrf_token() }}",
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            "width": "15%",
                            render: function (data, type, row) {
                                return '<a class="btn cur-p btn-primary editForm" title="Ubah" href="{{ route("be.product_subcategory.edit",["id"=>"/"]) }}/' + row.id +'" aria-pressed="false" autocomplete="off">Edit</a>'+
        ...
        function stateChange(e, id) {
            ...
            $.ajax({
                ...
                dataType: "json",
                url: '{{ $api_url."product/category/status" }}',
        ...
        function deleteRow(id) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url : '{{ $api_url."product/subcategory/delete" }}',
                        method : 'post',
                        data : {
                            token: "{{ csrf_token() }}",
                            id,
