            ...
            <div class="grid_layouts --two-auto">
                ...
                <div class="mn-rght">
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <a href="{{ route('be.retur_pembelian') }}">
                                Retur Pembelian
                            </a>
                        </li>
                    </ol>
		...
		<div class="row gap-20 pos-r">
			<div class="masonry-item col-md-12">
				<div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="grid_layouts --two-auto">
						<div class="head-lst">
							<h3 class="page-title">Retur Pembelian</h3>
						</div>
						<div class="mn-rght">
							<button class="addbsnt --pluses">
								<a href="{{ route('be.retur_pembelian.create') }}">
									<i class="ti-plus"></i>
								</a>
							</button>
						</div>
...
<script type="text/javascript">
    ...
    (function($) {
        ...
        $(document).ready(function() {
            dataTable = $('#DataTable').DataTable({
                ...
                ajax: {
                    url: "{{ $api_url.'retur_pembelian/table' }}",
                    type: "post",
                    dataType: "json",
                    data: {
                        _token: "{{csrf_token()}}",
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        className: 'text-center',
                        render: function (data, type, row) {
                            return '<button class="btn cur-p btn-secondary"> <a title="Lihat" class="product-detail" href="{{route("be.retur_pembelian.view",["id"=>""])}}'+row.id+'" aria-pressed="false">View</a></button>'
                                  +'<button class="btn cur-p btn-primary"><a title="Edit" class="product-detail" href="{{route("be.retur_pembelian.edit",["id"=>""])}}'+row.id+'" aria-pressed="false">Edit</a></button>';
                        }
                    },
                ],
            });
    ...
    function stateChange(e,id){
        ...
        $.ajax({
            ...
            dataType: "json",
            url: '{{ $api_url."retur_pembelian/status" }}',
