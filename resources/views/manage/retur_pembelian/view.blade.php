	...
	<div class="row gap-20 pos-r">
		<div class="masonry-item col-md-12">
			<div class="bgc-white bd bdrs-3 p-20 mB-20">
                <div class="grid_layouts --two-auto">
					<div class="head-lst">
						<h3 class="page-title">Retur Pembelian Detail View</h3>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-4">
                         <div class="form-group">
                            <label><b>Total Retur Pembelian</b></label><br>
						...
						<div class="form-group">
							<label><b>Retur Pembelian Status</b></label><br>
							<div id="status"></div>
						</div>
					</div>
				</div>
	...
	function getEditData(){
         $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#tanggal_pembelian').text(response.data.tanggal_retur);
