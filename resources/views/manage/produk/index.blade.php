...
@section('content')
    <div class="row gap-20 pos-r">
        <div class="masonry-item col-md-12">
            <div class="bgc-white bd bdrs-3 p-20 mB-20">
				...
				<table id="produkTable" class="table table-striped table-hover dt-responsive nowrap" style="width:100%">
    ...
    <!-- Modal View -->
    <div class="modal fade" role="dialog" id="modalViewproduk">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center">Data produk - <span id="nameproduk"></span></h3>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <p class="form-control-static">:  <span id="nameproduk"></span></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
        ...
        function openproduk(produk_id) {
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        var html = '';
                        $('#modalViewproduk #nameproduk').html(data.name);
                        $('#modalViewproduk #fotoproduk').html(data.foto);
                        $('#modalViewproduk').modal();
                    }
                },
                error: function (data) {
