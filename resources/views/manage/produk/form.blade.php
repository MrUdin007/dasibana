            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="formproduk" class="form m-t-20" action="{{ ($produk) ? route('produk.edit',$produk->id) : route('produk.add') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="control-label">Foto Produk<span class="text-danger">*</span></label>
                            <div class="input-group mb-3">
                                <input type="file" class="form-control" name="foto" id="foto" value="{{ (old('foto') ? old('foto') : ((isset($produk)) ? $produk->foto : '')) }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Link Shopee<span class="text-danger">*</span></label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label class="control-label">Link Tokopedia<span class="text-danger">*</span></label>
                            <div class="controls">
