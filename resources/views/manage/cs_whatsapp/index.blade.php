		...
		<div class="row gap-20 pos-r">
			<div class="masonry-item col-md-12">
				<div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="grid_layouts --two-auto">
						<div class="head-lst">
							<h3 class="page-title">CS Whatsapp</h3>
						</div>
						<div class="mn-rght">
							<button class="addbsnt --pluses">
								<a href="{{ route('be.cs_whatsapp.create') }}">
									<i class="ti-plus"></i>
								</a>
							</button>
						</div>
            ...
            $(document).ready(function() {
                dataTable = $('#DataTable').DataTable({
                    ...
                    language: {
                        ...
                        searchPlaceholder: 'Search CS Whatsapp'
                    },
                    ajax: {
                        url: "{{ $api_url.'cs/table' }}",
                        type: "post",
                        dataType: "json",
                		data: {
		                    _token: "{{ csrf_token() }}",
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            "width": "15%",
                            render: function (data, type, row) {
                                return '<a class="btn cur-p btn-primary editForm" title="Ubah" href="{{ route("be.cs_whatsapp.edit",["id"=>"/"]) }}/' + row.id +'" aria-pressed="false" autocomplete="off">Edit</a>'+
