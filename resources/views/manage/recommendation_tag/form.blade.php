...
@section('content')
    <div class="container-fluid">
        <div class="grid_layouts --two-auto">
            <div class="head-lst">
                <h5 class="page-title">
                    {{ Request::get('id') ? 'Edit Recommendation tag' : 'Add Recommendation tag' }}
                </h5>
            </div>
            <div class="mn-rght">
                <ol class="breadcrumb">
        ...
        <div class="row gap-20 pos-r">
            <div class="masonry-item col-md-12">
                <div class="bgc-white p-20 bd">
                    <div class="grid_layouts --two-auto">
						<div class="head-lst">
							<h3 class="page-title">{{ Request::get('id') ? 'Edit Recommendation tag' : 'Add Recommendation tag' }}</h3>
						</div>
					</div>
                    <div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Tag Name" value="" id="name" name="name" >
                                    </div>
                                    <div class="form-group">
                    ...
                    <div class="mt-4">
                        <a href="{{route('be.recommendation_tag')}}" class="btn btn-danger">Cancel</a>
...
$(document).ready(function() {
        ...
        $('#submitProduk').click(function (e) {
           ...
           // e.preventDefault();
            ...
            $.ajax({
                type:'post',
                url :'{{ $api_url."recommendation_tag/save" }}' ,
                data: {
                ...
                success: function (response) {
                    if(response.success == true){
                        ...
                        location.href = "{{ route('be.recommendation_tag') }}";
                    }else{
                       // swal.close();
    ...
    function instantGenerate(kode){
         $.ajax({
                ...
                dataType: "json",
                url: '{{ $api_url."recommendation_tag/instant_generate" }}',
    ...
    function getEditData(){
     ...
     $.ajax({
            type:'post',
            url :'{{ $api_url."recommendation_tag/edit" }}' ,
            data: {
               _token: '{{ csrf_token() }}',
               id:'{{Request::get("id")}}',
               api_token: "{{ auth()->user()->api_token }}"
