		...
		<div class="row gap-20 pos-r">
			<div class="masonry-item col-md-12">
				<div class="bgc-white bd bdrs-3 p-20 mB-20">
                    <div class="grid_layouts --two-auto">
                        <div class="head-lst">
                            <h3 class="page-title">Search Hint List</h3>
                        </div>
                        <div class="mn-rght">
                            <button class="addbsnt --pluses">
                                <a href="{{ route('be.search_hint.add') }}">
                                    <i class="ti-plus"></i>
                                </a>
                            </button>
                        </div>
	...
	<script type="text/javascript">
            ...
            $(document).ready(function() {
                datatableSize = $('#SizeDataTable').DataTable({
                    ...
                    language: {
                        ...
                        searchPlaceholder: 'Search Hint'
                    },
                    ajax: {
                        url: "{{ $api_url.'search_hint/table' }}",
                        type: "post",
                        dataType: "json",
                		data: {
		                    _token: "{{csrf_token()}}" ,
                    ...
                    columns: [
                        ...
                        },
                        {
                            ...
                            render: function (data, type, row) {
                                return '<button class="btn cur-p btn-primary editForm"> <a title="Ubah" href="{{ route("be.search_hint.edit",["id"=>""]) }}'+row.id+'" aria-pressed="false" autocomplete="off">Edit</a></button>'
        ...
        function deleteRow(id) {
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url : '{{ $api_url."search_hint/delete" }}',
                        method : 'post',
                        data : {
                            id : id,
                            api_token: "{{ auth()->user()->api_token }}"
        ...
        function stateChange(e, id) {
            ...
            $.ajax({
                ...
                dataType: "json",
                url : '{{ $api_url."search_hint/status" }}',
