            ...
            $(document).ready(function() {
                dataTable = $('#DataTable').DataTable({
                    ...
                    language: {
                        ...
                        searchPlaceholder: 'Search Staff List'
                    },
                    ajax: {
                        url: "{{ $api_url.'staff/table' }}",
                        type: "post",
                        dataType: "json",
                		data: {
		                    _token: "{{csrf_token()}}",
                    ...
                    columns: [
                        ...
                        { data: "email" },
                        {
                            ...
                            render: function (data, type, row) {
                                return '<a class="btn cur-p btn-primary editForm" title="Ubah" href="{{ route("be.staff.edit",["id"=>"/"]) }}/' + row.id +'" aria-pressed="false" autocomplete="off">Edit</a>'+
