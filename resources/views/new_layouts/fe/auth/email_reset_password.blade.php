...
<html lang="en">
    <head>
        ...
        <!-- ****** faviconit.com favicons ****** -->
        <title>Veganesia - Email Reset Password</title>
        <!-- Custom CSS -->
        <style>
            @font-face {
            ...
            <div id="mail" class="text-center">
                <div class="box-mail">
                    ...
                    <div class="content">
                        ...
                        <p class="artc-txt">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Euismod sollicitudin platea orci nascetur. Facilisi aenean ac sed erat adipiscing volutpat turpis faucibus felis. 
                        </p>
                        <a href="#" class="btn-vegan green-bg-btn">
                            reset password
                        </a>
                        <p class="artc-txt" style="text-align: center;">
                            Copyable link : 
                            <span>
                                <a href="#" style="color: #2d9cdb">
                                    testlink
                                </a>
                            </span>
                        </p>
